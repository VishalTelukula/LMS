...
angular.module("Search", ['ui.bootstrap']).controller("BookController",
    function ($scope, $http) {
        ...
        function loadBooks() {
            ...
            $http.get('http://localhost:8080/api/getBooks').then(function (response) {
        ...
        function loadBookedThings() {
            ...
            $http.get('http://localhost:8080/api/getBookingDetails').then(function (response) {
        ...
        $scope.deleteRows = function (bcache) {
            ...
            $http.post('http://localhost:8080/api/delBook/', $scope.delCart).then
            (function (response) {
